    ...
    items: [
      {
        ...
        projects: [
          ...
          },
          {
            ...
            category: "ai",
            tag: "AI 与计算机视觉",
            desc: "基于 3 台摄像头协同的 3D 视觉空间几何系统，预测货物总体积并精确盘点复杂遮挡环境下的托盘数量。",
            tech: ["Python", "YOLOv11", "OpenCV", "Open3D", "PyTorch", "Streamlit", "Plotly"],
            contributions: [
              "主导 YOLOv11 目标检测模型的研究、微调训练与计算机视觉算法研发，实现托盘与货物的精准识别和自动计数。",
              "结合 Open3D 与 OpenCV 研发多视角 3D 空间点云重构算法，估算体积并彻底攻克盲区与堆叠遮挡难题。",
              "基于 Streamlit 与 Plotly 独立搭建 3D 实时交互式 Base Demo (PoC) 原型系统，顺利通过客户方案技术评估与验收。"
            ],
            highlights: [
              "成功攻克真实物流仓储环境中的视角盲区与堆叠遮挡盘点难题。",
              "交付高质量 PoC 演示系统，为后续生产环境整线工业化落地奠定关键技术基础。"
            ]
          },
          {
